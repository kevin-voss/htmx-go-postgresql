...
```text
feat(step-27): add 422 fragments and inline HTMX issue updates
```

**Body (optional):**

```text
Complete STEP-27 so the next agent can continue from a green tree.
```
...
After commit, mark this step `done` in any tracker and **stop** — do not start STEP-28.
